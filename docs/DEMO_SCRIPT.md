...
“The project has 27 passing automated tests and five passing retrieval-evaluation cases. The application reports retrieval time, generation time, and total end-to-end time separately. Deep generation is slow on my CPU-based laptop, which is a documented hardware limitation rather than a cloud dependency.”
